...
import com.example.vakery.ics.Domain.Repositories.ICSSubjectFactory;
import com.example.vakery.ics.Domain.Repositories.LecturerFactory;
import com.example.vakery.ics.Domain.Repositories.MarkFactory;
import com.example.vakery.ics.Domain.Repositories.NotificationFactory;
import com.example.vakery.ics.Domain.Repositories.ScheduleFactory;
import com.example.vakery.ics.Domain.Repositories.TimeFactory;
...
public class DownloadInfo {
    ...
    public void checkForInformation() {
        ...
        ArrayList<Integer> lecturersId = LecturerFactory.getLecturersId();
            ...
            try {
                ...
                if (!new JSONObject(response).get("ics_subjects").equals(null)) {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        ICSSubjectFactory.addICSSubject(icsSubject);
                    }
                } else {}
                ...
                if (!new JSONObject(response).get("lecturers").equals(null)) {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        LecturerFactory.addLecturer(lecturer);
                    }
                } else {}
            ...
            try {
                ...
                if (!new JSONObject(response).get("subjects").equals(null)) {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        ScheduleFactory.addPersonalSubject(subject);
                    }
                } else {}
